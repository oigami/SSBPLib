...
#endif
	extern void SSDrawSprite(State state, const SSV3F_C4B_T2F_Quad& quad, int opacity, int Calc_opacity, BlendType blendType, BlendType colorBlendVertexType, int colorBlendVertexFlags);
#if 0
